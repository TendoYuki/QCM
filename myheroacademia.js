...
function calculer(){
	...
	if (res.textContent <5){
		natsume.textContent = "Bravo vous ne connaisez pas l'anime vous avez eu ";
	}
	else if (res.textContent == 5){
		natsume.textContent = "Felicitation vous etes moyen vous avez eu ";
	}
	else if (res.textContent > 5){
		natsume.textContent = "Felicitation vous connaisez bien My Hero Academia ! Vous avez eu ";
	}
	dix.textContent = " /10";
	reste.textContent = " N'hesitez pas à aller essayer notre qcm sur Blue Exorcist juste en dessous 👇 ";
