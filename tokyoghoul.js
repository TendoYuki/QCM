...
function calculer(){
	...
	if (res.textContent <5){
		...
		natsume.textContent = "Felicitation vous connaisez bien Tokyo Ghoul ! Vous avez eu ";
	}
	dix.textContent = " /10";
	reste.textContent = " N'hesitez pas à aller essayer notre qcm sur My Hero Academia juste en dessous 👇 ";
