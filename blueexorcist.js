...
function calculer(){
	...
	if (res.textContent <5){
		...
		natsume.textContent = "Felicitation vous connaisez bien Blue Exorcist ! Vous avez eu ";
	}
	dix.textContent = " /10";
	reste.textContent = " N'hesitez pas à aller essayer notre qcm sur The Seven Deadly Sins juste en dessous 👇 ";
