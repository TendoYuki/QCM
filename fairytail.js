...
function calculer(){
	...
	if (res.textContent <5){
		...
		natsume.textContent = "Felicitation vous connaisez bien FairyTail ! Vous avez eu ";
	}
	dix.textContent = " /10";
	reste.textContent = " N'hesitez pas à aller essayer notre qcm sur naruto juste en dessous 👇 ";
	naruto.textContent = NARUTO.link(l);
